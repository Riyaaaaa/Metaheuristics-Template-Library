...
public:
    ...
    typename std::tuple_element<layer_index+1, structure>::type layerForwardIterator();
    
    template<std::size_t layer_index,std::size_t unit_index>
    typename std::tuple_element<layer_index-1, structure>::type layerBackwordIterator();
};
